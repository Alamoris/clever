...
TODO: Изменить рендеры с рем накладками(больше их нет). Используется не 2 карбоновые пластины жесткости, а 4. +рендеры
...
1. Используя пазы, установите сверху карбоновую центральную деку.
...
2. Зафиксируйте лучи на раме, используя 8 винтов М3х8 и 6 стальных гаек, а также 2 стойки "мама-мама" 20 мм.
...
TODO: БЕКов вообще нет, все распаивается на пдб
...
TODO: Новый приемник, новые рендеры, новая настройка пульта, новый способ бинда
...
TODO: новый рендер(без старых комплектующих)
...
TODO: Новые рендеры PDB и монтажной пластины пк
...
TODO: 2 ветки для пиксрейсера и гусолетника
...
TODO: Переписать способ установки малины с разведенными осями(все рендеры переделать)
